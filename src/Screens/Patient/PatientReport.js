    ...
    <View style={styles.Container}>
      ...
      <View style={styles.box2}>
        <View style={styles.box3}>
          <View>
            <Water width={23} height={23} style={{marginTop:6}}/>
            <Text style={styles.text3}>Blood type</Text>
            <Text style={styles.text4}>A+</Text>
          </View>
          <WhiteHDots width={23} height={23} style={{marginRight: '5%'}} />
        </View>


         <View style={styles.box4}>
          <View>
            <Weight width={35} height={35} />
            <Text style={styles.text5}>Weight</Text>
            <Text style={styles.text6}>60 kg</Text>
          </View>
          <BlackDots width={23} height={23} style={{marginRight: '5%'}} />
        </View>
      </View>
